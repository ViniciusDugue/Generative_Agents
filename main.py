...
"If your fitness score is low, prioritize actions that boost your survival (e.g., GatherBehavior or RestBehavior). If it is high, you may risk exploring new areas using MoveBehavior, finding Blocks, or Building Walls, while always ensuring you flee from predators if detected."
